...
app.add_url_rule('/admin/course/<string:course_code>', 'admin_course', admin.course, methods=['GET', 'POST'])
app.add_url_rule('/admin/course/<string:course_code>/<string:exam_name>/', 'admin_exam', admin.exam, methods=['GET', 'POST'])
app.add_url_rule('/admin/question/<int:question_id>/', 'admin_question', admin.question, methods=['GET', 'POST'])
